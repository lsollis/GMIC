...
# In src/utilities/tools.py, replace the generate_mask_uplft function:
...
def generate_mask_uplft(input_image, window_shape, upper_left_points, gpu_number):
    ...
    # FIXED: Always move tensors to input_image's device for DataParallel compatibility
    # Move mask tensors to the same device as input_image (regardless of gpu_number)
